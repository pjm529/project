...
<link rel="stylesheet" href="/project/homepage/css/viewMenu.css">
<link rel="stylesheet"
                ...
                <form action="" method="post" onsubmit="return false;">
                    ...
                    <table id="view_recruit_info" align="center">
                        ...
                        <tr>
                            ...
                            <td class="td2" style="border-right: none;"><%=count %></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="td2" style="border-right: none;"><%=professor %></td>
                        </tr>
