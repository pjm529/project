                                ...
                                <tr>
                                    <td>
                                        <textarea cols="63" rows="1" id="training_period" name="training_period"
                                            style="resize: none;" placeholder="교육기간을 입력하세요."><%=training_period %></textarea>
                                    </td>

                                    <td>
                                        <textarea cols="64" rows="1" id="recruit_period" name="recruit_period"
                                            style="resize: none;" placeholder="모집기간을 입력하세요."><%=recruit_period %></textarea>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <textarea cols="63" rows="1" id="time" name="time" style="resize: none;"
                                            placeholder="수업시간을 입력하세요."><%=time %></textarea>
                                    </td>

                                    <td>
                                        <textarea cols="64" rows="1" id="count" name="count" style="resize: none;"
                                            placeholder="인원을 입력하세요."><%=count %></textarea>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <textarea cols="63" rows="1" id="location" name="location" style="resize: none;"
                                            placeholder="교육장소를 입력하세요."><%=location %></textarea>
                                    </td>

                                    <td>
                                        <textarea cols="64" rows="1" id="professor" name="professor"
                                            style="resize: none;" placeholder="담당교수를 입력하세요."><%=professor %></textarea>
                                    </td>
                                </tr>
                            </table>
    ...
    <script>
		$(function () {
			...
			$("#list_btn").click(function() {
				 window.location.href = '../recruit.jsp';
			});
		});
